<?php
class Np_Vendor_Adminhtml_Vendor_AttributeController extends Mage_Adminhtml_Controller_Action {
	...
	public function preDispatch() {
		parent::preDispatch();
		$this->_entityTypeId = Mage::getModel('eav/entity')->setType(Np_Vendor_Model_Resource_Vendor::ENTITY)->getTypeId();
	}
