            ...
            <table>
                <form action="<?php echo $this->getUrl('savePaymentMethod');?>" method="POST">
                    <?php foreach ($paymentMethods as $paymentMethod) : ?>
                        <tr>
                            <td><input type="radio" name="paymentMethod" value="<?php echo $paymentMethod->methodId ?>" <?php echo ($paymentMethod->methodId == $cart->paymentMethod)?'checked' : '' ?>><?php echo $paymentMethod->name ?></td>
                        </tr>
                    <?php endforeach;?>
                    <tr>
            ...
            <table>
                <form action="<?php echo $this->getUrl('saveShipingMethod');?>" method="POST">
                    <?php foreach ($shippingMethods as $shippingMethod) : ?>
                        <tr>
                            <td><input type="radio" name="shippingMethod" value="<?php echo $shippingMethod->methodId ?>" <?php echo ($shippingMethod->methodId == $cart->shippingMethod)?'checked' : '' ?>><?php echo $shippingMethod->name ?></td>
